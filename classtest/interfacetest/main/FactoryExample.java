...
import classtest.interfacetest.CarFactory;
import classtest.interfacetest.Factory;
import classtest.interfacetest.IWorkingTogether;
import classtest.interfacetest.TVFactory;
...
public class FactoryExample {
	...
	public void getResult(Factory mainFactory, char mainFactorySkill, IWorkingTogether partner) {
		...
		IWorkingTogether factory = (IWorkingTogether)mainFactory;
		...
		System.out.println("2. 파트너 공장 [" + otherFactory.getFactoryName() + "] 협력 시 추가 생산량 = " + factory.workTogether(partner));
		System.out.println("--------------------------------------------------------------");
	}
